...
We must designate approximately 86 clusters for random assignation to "spray" / "no-spray" groups. These clusters have no size restrictions, but must not divide villages, must contain a buffer of at least 1 kilometer, and buffers may not overlap (effectively making the buffer size 2 kilometers).
