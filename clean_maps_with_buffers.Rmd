...
For example, for the residents of the village of Ntada, they are all within the core area.

```{r}
leaflet_village_clean_with_voronoi_buffer(1)
```

For the 166 villagers of Bone, most are in the core (a few are in the buffer).
