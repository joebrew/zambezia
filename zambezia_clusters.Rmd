...
author: Joe Brew, Charfudin Sacoor, Carlos Chaccour
fig_height: 2.6
fig_width: 4
output:
  html_document:
...
mop <- zam[zam@data$NAME_3 == 'Mopeia',]
...
One simple algorithmic approach for the creation of clusters is K-means. It is xxx. However, the problem is that parameters have more to do with proximity, and less to do with boundaries and buffers.
...
points(census_spatial, col = colors, pch = '.', cex = 3)
# points(x$centers,
#      pch = 3)
```
...
for (i in 1:nrow(cluster_df)){
  ...
  points(these_points, col = cols[i], pch = '.', cex = 0.1)
  })
}
